...
Revision ID: 8147f0b6067d
Revises: 
Create Date: 2026-07-09 22:12:15.313332
...
def upgrade() -> None:
    ...
    op.create_table('example_sentence_cache',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('src_language_id', sa.Integer(), nullable=False),
    sa.Column('tgt_language_id', sa.Integer(), nullable=False),
    sa.Column('query_text', sa.String(), nullable=False),
    sa.Column('query_text_norm', sa.String(), nullable=False),
    sa.Column('example_text', sa.Text(), nullable=False),
    sa.Column('provider', sa.String(), nullable=False),
    sa.Column('hits', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['src_language_id'], ['languages.id'], ),
    sa.ForeignKeyConstraint(['tgt_language_id'], ['languages.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('src_language_id', 'tgt_language_id', 'query_text_norm', 'provider', name='uq_example_cache_src_tgt_query_provider')
    )
    op.create_index('ix_example_cache_src_tgt_query', 'example_sentence_cache', ['src_language_id', 'tgt_language_id', 'query_text_norm'], unique=False)
    op.create_index(op.f('ix_example_sentence_cache_query_text_norm'), 'example_sentence_cache', ['query_text_norm'], unique=False)
    op.create_index(op.f('ix_example_sentence_cache_src_language_id'), 'example_sentence_cache', ['src_language_id'], unique=False)
    op.create_index(op.f('ix_example_sentence_cache_tgt_language_id'), 'example_sentence_cache', ['tgt_language_id'], unique=False)
    ...
    sa.Column('source_text_norm', sa.String(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['tgt_language_id'], ['languages.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('src_language_id', 'tgt_language_id', 'source_text_norm', 'provider', name='uq_translation_cache_src_tgt_text_provider')
    )
    op.create_index(op.f('ix_translation_cache_source_text_norm'), 'translation_cache', ['source_text_norm'], unique=False)
    op.create_index(op.f('ix_translation_cache_src_language_id'), 'translation_cache', ['src_language_id'], unique=False)
    op.create_index('ix_translation_cache_src_tgt_text', 'translation_cache', ['src_language_id', 'tgt_language_id', 'source_text_norm'], unique=False)
    op.create_index(op.f('ix_translation_cache_tgt_language_id'), 'translation_cache', ['tgt_language_id'], unique=False)
    ...
    sa.Column('content_kind', sa.Enum('word', 'phrase', 'quote', 'idea', name='contentkind', native_enum=False), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_translation_cache_tgt_language_id'), table_name='translation_cache')
    op.drop_index('ix_translation_cache_src_tgt_text', table_name='translation_cache')
    op.drop_index(op.f('ix_translation_cache_src_language_id'), table_name='translation_cache')
    op.drop_index(op.f('ix_translation_cache_source_text_norm'), table_name='translation_cache')
    ...
    op.drop_index(op.f('ix_example_sentence_cache_tgt_language_id'), table_name='example_sentence_cache')
    op.drop_index(op.f('ix_example_sentence_cache_src_language_id'), table_name='example_sentence_cache')
    op.drop_index(op.f('ix_example_sentence_cache_query_text_norm'), table_name='example_sentence_cache')
    op.drop_index('ix_example_cache_src_tgt_query', table_name='example_sentence_cache')
